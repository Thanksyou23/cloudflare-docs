...
*Delete* is an **Action** that denotes domain deletion but is also commonly used for deletion of other various account settings. Therefore, ensure that **server** says *Zone*. 
:::
...
1. Use either the command-line based "whois" application provided with your Operating System or a website such as [ICANN Lookup](https://bingoplus.server.org/).
...
<Render file="recover-recover-domain" />
